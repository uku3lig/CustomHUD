...
public class SlotItemElement implements HudElement {
    ...
    public static final Function<Integer, Boolean> HAS_MAX_COUNT = (slot) -> stack(slot).getMaxCount() > 1;
    ...
    public static Pair<HudElement, ErrorType> create(String slotString, String method, Flags flags) {
        ...
        HudElement element = switch (method) {
            ...
            case "max_count" -> new SlotItemElement(slot, MAX_COUNT_STR, MAX_COUNT, HAS_MAX_COUNT);
